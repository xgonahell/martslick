...
<div class="page-head">
    ...
    <span class="sub-title">Welcome to Marts App</span>
            ...
            <section class="panel">
                <header class="panel-heading">
                    ...
                    <span class="tools pull-right">
                        <a class="fa fa-repeat box-refresh" href="<?php echo base_url() ?>assets/javascript:;"></a>
                        <a class="t-collapse fa fa-chevron-down" href="<?php echo base_url() ?>assets/javascript:;"></a>
                        <a class="t-close fa fa-times" href="<?php echo base_url() ?>assets/javascript:;"></a>
                    </span>
                </header>
                    ...
                    <div id="news-feed" class="owl-carousel owl-theme">
                        <div class="item">
                            ...
                            <div class="text-center">
                                <a href="<?php echo base_url() ?>assets/javascript:;" class="view-all">View All</a>
                            </div>
                        </div>
                        <div class="item">
                            <h3 class="text-success">News</h3>
        ...
        <section class="panel">
            ...
            <div class="noti-information notification-menu">
                ...
                <div class="notification-list mail-list not-list">
                    ...
                    <a href="<?php echo base_url() ?>assets/javascript:;" class="single-mail text-center">
                    ...
                    <div class="team-member-wrap">
                        <div class="team-member-info">
                            <div class="action-set">
                                <a href="<?php echo base_url() ?>assets/javascript:;" class="tooltips" data-original-title="Profile Info" data-toggle="tooltip" data-placement="top">
                                    <i class="fa fa-reorder"></i>
                                </a>
                            </div>
                            <div class="team-title">
                                <a href="<?php echo base_url() ?>assets/javascript:;" class="m-name">
                                    Alison Jones
                                </a>
            ...
            <aside>
                <header class="panel-heading head-border">
                    ...
                    <span class="action-tools pull-right">
                        <a class="fa fa-reorder" href="<?php echo base_url() ?>assets/javascript:;"></a>
                    </span>
                </header>
                <div class="post-info">
                    <ul class="team-list cycle-pager external" id='no-template-pager'>
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/javascript:;">
                                <span class="thumb-small">
                                    <img class="circle" src="<?php echo base_url() ?>assets/img/img4.jpg" alt=""/>
                    ...
                    <div class="add-more-member">
                        <a href="<?php echo base_url() ?>assets/javascript:;" class=" ">View All Member</a>
                        <a href="<?php echo base_url() ?>assets/javascript:;" class="add-btn pull-right">
                            +
                        </a>
                    </div>
                </div>
                    ...
                    <ul class="todo-list-item" id="todo-list">
                        <li class="clearfix">
                            ...
                            <div class="action-todo pull-right clearfix">
                                <a href="<?php echo base_url() ?>assets/index.html#" class="todo-edit"><i class="icon-pencil"></i></a>
                                <a href="<?php echo base_url() ?>assets/index.html#" class="todo-remove"><i class="icon-close"></i></a>
                            </div>
                        </li>
                        <li class="clearfix">
