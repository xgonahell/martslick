...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url() ?>assets/javascript:;" type="image/png">

    <title>Marts - Marketing Architecture System</title>
    ...
    <section>
            ...
            <div class="sidebar-left-info">
                ...
                <div class="sidebar-widget">
                    ...
                    <ul class="list-group">
                        ...
                        <li><a href="<?php echo base_url() ?>assets/javascript:;" class="btn btn-success btn-sm ">View Details</a></li>
                    </ul>
                </div>
                <!--sidebar widget end-->
        ...
        <div class="body-content" >
            ...
            <div class="header-section">
                ...
                <div id="navbar-collapse-1" class="navbar-collapse collapse yamm mega-menu">
                    <ul class="nav navbar-nav">
                        <!-- Classic list -->
                        <li class="dropdown"><a href="<?php echo base_url() ?>assets/javascript:;" data-toggle="dropdown" class="dropdown-toggle">Mega <b
                                    ...
                                    <div class="yamm-content">
                                        <div class="row">
                                            <ul class="col-sm-2 list-unstyled">
                                                ...
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Slick Mega Navigation </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Built in BS3+</a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Full Customizable </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Huge Components </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Tons of widgets </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"> Fontawesome </a>
                                                </li>
                                            </ul>
                                            <ul class="col-sm-2 list-unstyled">
                                                <li>
                                            ...
                                            <ul class="col-sm-2 list-unstyled">
                                                ...
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"><i class="fa fa-anchor text-muted"></i> Anchor Icon </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"><i class="fa fa-desktop text-muted"></i> Desktop Icon </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"><i class="fa fa-laptop text-muted"></i> Laptop Icon</a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"><i class="fa fa-automobile text-muted"></i> Automobile Icon </a>
                                                </li>
                                                <li><a href="<?php echo base_url() ?>assets/javascript:;"><i class="fa fa-briefcase text-muted"></i> Briefcase Icon</a>
                                                </li>
                                            </ul>
                        ...
                        <!-- Classic dropdown -->
                        <li class="dropdown"><a href="<?php echo base_url() ?>assets/javascript:;" data-toggle="dropdown" class="dropdown-toggle"> English  <b
                                class=" fa fa-angle-down"></b></a>
                            <ul role="menu" class="dropdown-menu language-switch">
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url() ?>assets/javascript:;"><span> German </span><img src="<?php echo base_url() ?>assets/img/flags/germany_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url() ?>assets/javascript:;"><span> Italian </span> <img src="<?php echo base_url() ?>assets/img/flags/italy_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url() ?>assets/javascript:;"><span> French </span> <img src="<?php echo base_url() ?>assets/img/flags/french_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url() ?>assets/javascript:;"><span> Spanish </span> <img src="<?php echo base_url() ?>assets/img/flags/spain_flag.jpg" alt=""/></a>
                                </li>
                                <li>
                                    <a tabindex="-1" href="<?php echo base_url() ?>assets/javascript:;"><span> Russian </span> <img src="<?php echo base_url() ?>assets/img/flags/russia_flag.jpg" alt=""/></a>
                                </li>
                            </ul>
                        </li>
                ...
                <!--mail info start-->
                <li class="d-none">
                    <a href="<?php echo base_url() ?>assets/javascript:;" class="btn btn-default dropdown-toggle info-number" data-toggle="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-title">
                        <div class="title-row">
                            ...
                            <a href="<?php echo base_url() ?>assets/javascript:;" class="btn-primary btn-view-all">View all</a>
                        </div>
                        <div class="notification-list mail-list">
                            <a href="<?php echo base_url() ?>assets/javascript:;" class="single-mail">
                ...
                <li class="d-none">
                    ...
                    <div class="dropdown-menu dropdown-title">
                        <div class="title-row">
                            ...
                            <a href="<?php echo base_url() ?>assets/javascript:;" class="btn-success btn-view-all">View all</a>
                        </div>
                ...
                <li>
                    ...
                    <div class="dropdown-menu dropdown-title ">
                        ...
                        <div class="title-row">
                            ...
                            <a href="<?php echo base_url() ?>assets/javascript:;" class="btn-warning btn-view-all">View all</a>
                        </div>
                ...
                <div class="right-notification">
                    <ul class="notification-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>assets/javascript:;" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url() ?>assets/img/avatar-mini.jpg" alt="">John Doe
            ...
            <ul class="nav nav-tabs nav-justified-">
                <li class="active">
                    <a href="<?php echo base_url() ?>assets/index.html#chat" data-toggle="tab">Chat</a>
                </li>
                <li class="">
                    <a href="<?php echo base_url() ?>assets/index.html#info" data-toggle="tab">Info</a>
                </li>
                <li class="">
                    <a href="<?php echo base_url() ?>assets/index.html#settings" data-toggle="tab">Settings</a>
                </li>
            </ul>
                ...
                <div class="online-chat">
                    <div class="online-chat-container">
                        <div class="chat-list">
                            ...
                            <a href="<?php echo base_url() ?>assets/index.html#" class="add-people tooltips" data-original-title="Add People" data-toggle="tooltip" data-placement="left">
            ...
            <div class="chat-list info">
                ...
                <a  href="<?php echo base_url() ?>assets/javascript:;" class="add-people tooltips" data-original-title="Refresh" data-toggle="tooltip" data-placement="left">
            ...
            <div class="aside-widget">
                <div class="side-title-alt">
                    <h2>Revenue</h2>
                    <a href="<?php echo base_url() ?>assets/index.html#" class="close side-w-close">
